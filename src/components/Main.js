            ...
            <section className="hero iphone-12">
                <div className="container">
                    <div className="title">
                        ...
                        <p className="title-info">From $29.12/mo. for 24 mo. or $699 before trade-in.1
            ...
            <section className="hero iphone-12-pro">
                <div className="container">
                    <div className="title title-dark">
                        ...
                        <p className="title-info">From $41.62/mo. for 24 mo. or $999 before trade-in.2
                        Buy directly from Apple with special carrier offers.</p>
                    </div>
                    <div className="cta">
                    ...
                    <div className="col-md">
                        <section className="hero airpods">
                            <div className="container">
                                ...
                                <div className="cta">
                                    <a href="#" className="cta-link">Watch the film</a>
                                    <a href="#" className="cta-link">Buy</a>
                                </div>
                            </div>
                        </section>
                    ...
                    <div className="col-md">
                        <section className="hero card">
                            <div className="container">
                                ...
                                <div className="cta">
                                    <a href="#" className="cta-link">Learn more</a>
                                    <a href="#" className="cta-link">Apply now</a>
                                </div>
                            </div>
                        </section>
                    </div>
                    <div className="col-md">
                        <section className="hero films">
                            <div className="container">
                                ...
                                <div className="cta">
                                    <a href="#" className="cta-link">Watch now</a>
                                </div>
                            </div>
                        </section>
                    </div>
